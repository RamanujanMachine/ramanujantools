...
def test_non_unique_solution():
    ...
    original_solution = EulerSolution(h_1=Poly(1, x), h_2=Poly(1, x), a=Poly(2, x), b=Poly(-1, x), f=Poly(x+f_0))
    solution = EulerSolver.solve_for_decomposition_with_degree(
        a=original_solution.a, h_1=original_solution.h_1, h_2=original_solution.h_2, d_f=1)
